                    ...
                    <div class="user-card-design">
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                <h2 class="card-title text-center mb-5">Es Teh Hangat</h2>
                                <h5 class="card-text">Rak : </h5>
                                <h5 class="card-text">Kategori : </h5>
                                <h5 class="card-text">Kolom : </h5>
                                <h5 class="card-text">Stok : </h5>
                                </div>
            ...
            <div class="modal-body">
                <div class="accordion" id="accordionExample">
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <form class="accordion-body form-control" action="<?=BASEURL?>/add/tambah" method="POST">
                            <div class="mb-3 row">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <form class="accordion-body form-control">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-7">
                                <input type="text" class="form-control" id="inputKolom">
                                </div>
                            </div>
                            <div class="mb-3 row">
