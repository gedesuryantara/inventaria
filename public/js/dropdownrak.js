...
fetch('js/sambungan.php')
    ...
    .then(data => {
        ...
        // var idrakdata = data.id_rak;
        // var rakdata = data.nama_rak;
        // var jumlahkolom = data.jumlah_kolom;
        // // Data JSON yang diambil dari PHP tersedia di sini
        // console.log(idrakdata);
        ...
        // jumlahkolom.textContent = data.jumlah_kolom;
